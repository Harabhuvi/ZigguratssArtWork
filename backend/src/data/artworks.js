...
export const categories = [
  { id: "all", name: "All Works", count: 9 },
  { id: "painting", name: "Paintings", count: 3, description: "Oil, acrylic, and mixed media canvases" },
  { id: "sculpture", name: "Sculptures", count: 3, description: "Marble, bronze, glass, and tactile structures" },
  { id: "digital_art", name: "Digital Art", count: 3, description: "Generative algorithms, 3D renders, and editions" }
];
